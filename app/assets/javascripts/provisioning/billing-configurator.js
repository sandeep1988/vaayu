...
function generate_edit(response, type, operator_id, orig_service_html){
    ...
    if(type == 'site'){
        ...
        '<div class="row">' + 
            '<div class="col-md-12">'+
                '<div style="border: 1px solid #8d8e90;display: inline-block;margin-top: 20px;padding-top: 10px;padding-bottom: 20px;">' + 
                    '<div class="col-md-12" style="font-size: medium;text-align: center;padding: 10px;font-weight: bold;"> Primary Details </div>'+
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="siteName">Site Name*    </label>' + 
                        '<input class="form-control" id="siteName" name="siteName" type="text" value="' + response.site.name + '" required="true">' + 
                    '</div>' + 
                    '<div class="col-md-4 no-margin">' + 
            ...
            console.log("======", response.site.contact_phone == "null" );
            ...
            html = html + 
                    ...
                    '<div class="col-md-4 no-margin">' + 
                        ...
                        '<input class="form-control" id="site_code" name="site_code" type="text" value="' + `${!response.site.site_code ? "": response.site.site_code}`  + '" required="true" readonly>' + 
                    '</div>' +
            '<div class="col-md-4"><label class="site_labels" for="sezNonSez">Sez / Non Sez *</label>\
                <select class="form-control sezNonSez" data-vehiclenumber="1" id="sezNonSez" >\
                <option '+strSelectedNon+' value="non sez" >Non SEZ</option>\
                <option  '+strSelectedSez+' value="sez"> SEZ </option>\
                    ...
                    '<div class="col-md-4 no-margin">' + 
                        ...
                        '<input class="form-control" id="address" name="address" type="text" value="' + `${!response.site.address ? "": response.site.address}`  + '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="address2">Address2</label>' + 
                        '<input class="form-control" id="address2" name="address2" type="text" value="' + `${!response.site.address_2 ? "": response.site.address_2}` + '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin ">' + 
                        '<label class="site_labels" for="pin">PIN *</label>' + 
                        '<input class="form-control" id="pin" name="pin" type="text" value="' + `${!response.site.pin ? "": response.site.pin}` + '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="state">State *</label>' + 
                        '<input class="form-control" id="state" name="state" type="text" value="' + `${!response.site.state ? "": response.site.state}`  + '" required="true">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                    ...
                    //     '<input class="form-control" id="address_3" name="address_3" type="text" value="' + response.site.address_3 + '">' + 
                    // '</div>' +
                    // '<div class="col-md-4 no-margin">' + 
                    //     '<label class="site_labels" for="pin">PIN*</label>' + 
                    //     '<input class="form-control" id="pin" name="pin" type="text" value="' + response.site.pin + '" required="true">' + 
                    // '</div>' +
                    // '<div class="col-md-4 no-margin">' + 
                    //     '<label class="site_labels" for="state">state*</label>' + 
                    //     '<input class="form-control" id="state" name="pin" type="text" value="' + response.site.state + '" required="true">' + 
                    // '</div>' +
                    // '<div class="col-md-4 no-margin">' + 
                    //     '<label class="site_labels" for="city">city*</label>' + 
                    ...
                    '<div class="col-md-4 no-margin">' + 
                        ...
                        '<input class="form-control" id="phone_2" name="phone_2" type="text" value="' + `${!response.site.phone_2 ? "": response.site.phone_2}`  + '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="party_business_area">MLL Business Area *</label>' + 
                        '<input class="form-control" id="party_business_area" name="party_business_area" type="text" value="' + `${!response.site.party_business_area? "": response.site.party_business_area}`  + '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="pan_no">PAN *</label>' + 
                        '<input class="form-control" id="pan_no" name="pan_no" type="text" value="' + `${!response.site.pan_no ? "": response.site.pan_no}`  + '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="gstin_no">GSTIN *</label>' + 
                        '<input class="form-control" id="gstin_no" name="gstin_no" type="text" value="' + `${!response.site.gstin_no ? "": response.site.gstin_no}`  + '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="latitude">Lat *</label>' + 
                        '<input class="form-control" id="latitude" name="latitude" type="text" value="' + `${!response.site.latitude ? "": response.site.latitude}`  + '">' + 
                    '</div>' + 
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="longitude">Long *</label>' + 
                        '<input class="form-control" id="longitude" name="longitude" type="text" value="' + `${!response.site.longitude ? "": response.site.longitude}`  + '">' + 
                    '</div>' + 
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="proximity_radius">Proximity Radius (metres) </label>' + 
                        '<input class="form-control" id="proximity_radius" name="proximity_radius" type="text" value="' + `${!response.site.proximity_radius ? "":response.site.proximity_radius}` + '">' + 
                    '</div>' + 
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="contact_name">Contact Name </label>' + 
                        '<input class="form-control" id="contact_name" name="contact_name" type="text" value="' + `${!response.site.contact_name ? "": response.site.contact_name}` + '">' + 
                    '</div>' + 
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="contact_phone">Contact Phone </label>' + 
                        '<input class="form-control" id="contact_phone" name="contact_phone" type="text" value="' + `${!response.site.contact_phone ? "": response.site.contact_phone }` +'">' + 
                    '</div>' + 
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="contact_email">Contact Email </label>' + 
                        '<input class="form-control" id="contact_email" name="contact_email" type="text" value="' + `${!response.site.contact_email ? "": response.site.contact_email}`  + '">' + 
                    '</div>' + 
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="cost_centre">Cost Centre</label>' + 
                        '<input class="form-control" id="cost_centre" name="cost_centre" type="text" value="' + `${!response.site.cost_centre ? "": response.site.cost_centre}`  + '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="profit_centre">Profit Centre</label>' + 
                        '<input class="form-control" id="profit_centre" name="profit_centre" type="text" value="' + `${!response.site.profit_centre ? "": response.site.profit_centre}`  + '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="gl_acc_no">GL Acc No </label>' + 
                        '<input class="form-control" id="gl_acc_no" name="gl_acc_no" type="text" value="' + `${!response.site.gl_acc_no ? "": response.site.gl_acc_no}`  + '">' + 
                    '</div>' +
                    '<div class="col-md-4">\
                        <label class="site_labels" for="active">Active/Inactive</label>\
                        <select class="form-control sezNonSez" id="active">\
                            <option '+`${response.site.active == true ? "selected":""}`+' value="yes">Yes</option>\
                            <option '+`${response.site.active == false ? "selected":""}`+' value="no">No</option>\
                        </select>\
                    </div>'+
                '</div>' +  
            '</div>' +    
        ...
        '<div class="row">' + 
            '<div class="col-md-12">'+            
                '<div style="border: 1px solid #8d8e90;display: inline-block;margin-top: 20px;padding-top: 10px;padding-bottom: 20px;">' + 
                    '<div class="col-md-12" style="font-size: medium;text-align: center;padding: 10px;font-weight: bold;">Billing Party Details </div>'+            
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="party_code">Party Code *</label>' + 
                        '<input class="form-control" id="party_code" name="party_code" type="text" value="' + `${!response.site.party_code ? "": response.site.party_code }` + '" readonly>' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="party_name">Party Name*</label>' + 
                        '<input class="form-control" id="party_name" name="party_name" type="text" value="' +  `${!response.site.party_name ? "": response.site.party_name}`+ '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="sap_control_number">SAP Control Number</label>' + 
                        '<input class="form-control" id="sap_control_number" name="sap_control_number" type="text" value="' + `${!response.site.sap_control_number ? "": response.site.sap_control_number}` + '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="party_contact_name">Contact Name *</label>' + 
                        '<input class="form-control" id="party_contact_name" name="party_contact_name" type="text" value="' +  `${!response.site.party_contact_name ? "": response.site.party_contact_name}`+ '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="party_address_1">Address 1 *</label>' + 
                        '<input class="form-control" id="party_address_1" name="party_address_1" type="text" value="' + `${!response.site.party_address_1 ? "": response.site.party_address_1}` + '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="party_address_2">Address 2</label>' + 
                        '<input class="form-control" id="party_address_2" name="party_address_2" type="text" value="' + `${!response.site.party_address_2 ? "": response.site.party_address_2}` + '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="party_pin">PIN *</label>' + 
                        '<input class="form-control" id="party_pin" name="party_pin" type="text" value="' + `${!response.site.party_pin ? "": response.site.party_pin}`  + '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="party_city">City *</label>' + 
                        '<input class="form-control" id="party_city" name="party_city" type="text" value="' + `${!response.site.party_city ? "": response.site.party_city}` + '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="party_state">State *</label>' + 
                        '<input class="form-control" id="party_state" name="party_state" type="text" value="' +  `${!response.site.party_state ? "": response.site.party_state}`+ '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                    ...
                    '<div class="col-md-4 no-margin">' + 
                        ...
                        '<input class="form-control" id="party_pan_no" name="party_pan_no" type="text" value="' + `${!response.site.party_pan_no ? "": response.site.party_pan_no}` + '">' + 
                    '</div>' +
                    '<div class="col-md-4 no-margin">' + 
                        '<label class="site_labels" for="party_gstin_no">GSTIN *</label>' + 
                        '<input class="form-control" id="party_gstin_no" name="party_gstin_no" type="text" value="' + `${!response.site.party_gstin_no ? "": response.site.party_gstin_no}` + '">' + 
                    '</div>' +
                    '</div>' +
            '</div>' +       
        '</div>' +  
        '<div style="display:none">' +  
            '<p style="font-size:18px; font-weight:600; margin-left:10px ; display: none">Billing Attributes</p>' + 
            '<div class="row">'
