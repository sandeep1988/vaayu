var app = angular.module('app', ['ui.router','dndLists','rzSlider','ngResource', 'ui.bootstrap','toaster', 'ngAnimate', 'angularjs-dropdown-multiselect','cp.ngConfirm','wu.masonry','ui.select']);
