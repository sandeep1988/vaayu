app.controller('contractListAddCtrl', function ($scope, $http, $state, SessionService, ToasterService, $timeout) {
    ...
    //     $http({
    //         method: 'GET',
    //         url: 'http://operatorptsdemo.devmll.com:8003/api/v1/contract/download-samplefile/'+id+'/'+type,
    //         headers: {
    //             'Content-Type': 'application/json',
    //             'uid': SessionService.uid,
    //             'access_token': SessionService.access_token,
    ...
    $scope.createContract = function () {
        ...
        var vm = $scope;
        request.open("POST", "http://operatorptsdemo.devmll.com:8003/api/v1/" + contractType + "/upload");
    ...
    $scope.getContracts = () => {
        ...
        let url = 'http://operatorptsdemo.devmll.com/getContractListByCustId?custId=1&custType=' + $scope.tab + '&siteId=' + urlEnd;
    ...
    $scope.downloadSampleFile = () => {
        ...
        let url = 'http://operatorptsdemo.devmll.com:8003/api/v1/contract/download-samplefile/'+id+'/'+type+'/'+$scope.ctype
        a.href = url;
    ...
    $scope.fetchBAList = () => {
        ...
        $http({
            method: 'POST',
            url: 'http://operatorptsdemo.devmll.com/induction/getAllBaList',
            headers: {
                'Content-Type': 'application/json',
                'uid': SessionService.uid,
                'access_token': SessionService.access_token,
