class API::V2::DriversController < ApplicationController
  ...
  def create
    if params[:registration_steps] == "Step_1"
      ...
      user.entity.marital_status = params[:marital_status]
